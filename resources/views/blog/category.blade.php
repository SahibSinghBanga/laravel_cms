        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-xl-9">
                    ...
                    <!--
                        * Pagination Comming Here From:
                        *
                        * Method: SimplePaginate In Controller (WelcomeController ):resources/views/vendor/pagination/simple-bootstrap-4.blade file
                        *
                        * Method: Paginate In Controller (WelcomeController ):resources/views/vendor/pagination/bootstrap-4.blade file
                    -->
