...
<div class="card card-default">
    ...
    <div class="card-header"><strong>Categories</strong>
        <a href="{{ route('categories.create') }}" class="btn btn-success btn-sm float-right"><strong>Add Category</strong></a>
    </div>
                ...
                @foreach($categories as $category)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-info btn-sm text-white">
                                Edit
                            </a>
